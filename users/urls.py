...
urlpatterns = [
    path('google/', views.sign_in, name='sign_in'),
    path('google/sign-out', views.sign_out, name='sign_out'),
    path('google/auth-receiver', views.auth_receiver, name='auth_receiver'),
